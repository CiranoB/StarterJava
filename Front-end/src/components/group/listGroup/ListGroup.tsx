...
import { deleteDiet, deleteGroup, getIdNutritionist } from '../../../services/Service';
...
function ListDiet() {
  ...
  async function deleteGroupList(uuidGroup: string) {
    try {
      await deleteGroup(`/nutritionist/group/delete/${uuidGroup}`, {
        headers: {
          Authorization: tokenLogin
        }
      })
              ...
              < Card className={classes.root} variant="outlined">
                <CardContent>
                  ...
                  <Typography variant="h6" component="h2">
                    Máximo de caloria: {(group.maxKcalGroup).toFixed(2)} calorias.
                  </Typography>
                  <Typography variant="h6" component="h2">
                    Mínimo de caloria: {(group.minKcalGroup).toFixed(2)} calorias.
                  </Typography>
                  <br />
                  ...
                  >
                    <Fade in={open}>
                      <div className={classes.paper}>
                        ...
                        <Button size="small" className='buttonNav' onClick={() => deleteGroupList(diet.uuidDiet)}>Sim</Button>
